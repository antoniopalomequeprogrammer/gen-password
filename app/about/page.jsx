...
const AboutPage = () => {
  return (
    <div className="p-4">
      ...
      {/* Experiencia */}
      <div className="mt-4 grid  max-w-6xl mx-auto md:grid-cols-2 gap-4 lg:grid-cols-1 bg-white rounded shadow p-5">
        <div>
          <h2 className="text-slate-800 text-xl mb-3">Experiencia</h2>
          <ol class=" overflow-hidden space-y-8">
            <li class="relative flex-1 after:content-['']  after:w-0.5 after:h-full  after:bg-indigo-600 after:inline-block after:absolute after:-bottom-11 after:left-4 lg:after:left-5">
              <a class="flex items-center font-medium w-full  ">
                ...
                <div class="block">
                  <h4 class="text-md  text-indigo-600">
                    AICOR Consultores Informáticos{" "}
                  </h4>
                  <span class="text-sm">Mayo 2021 - Actualidad</span>
                </div>
              </a>
            </li>
            <li class="relative flex-1 after:content-['']  after:w-0.5 after:h-full  after:bg-gray-200 after:inline-block after:absolute after:-bottom-12 after:left-4 lg:after:left-5">
              <a class="flex items-center font-medium w-full  ">
                <span class="w-8 h-8 bg-indigo-50  border-2 border-indigo-600 rounded-full flex justify-center items-center mr-3 text-sm text-indigo-600 lg:w-10 lg:h-10">
                  2
                </span>
                <div class="block">
                  <h4 class="text-lg  text-indigo-600">
                    Sj Social Media Marketing
                  </h4>
                  <span class="text-sm">Enero 2021 - Abril 2021</span>
                </div>
              </a>
            </li>
          </ol>
